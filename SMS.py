...
def takok():
	lg=input("Spam Lagi? (y/n): ")
	if lg == "y" or lg == "Y":
	        os.system("python SMS.py")
	elif lg == "n" or lg == "N":
        	sys.exit("THX FOR USING TOOLS")
        	sleep(3)
	elif lg == "" or lg == " ":
		syst.exit("Wrong Input!!!")
		takok()

import os,sys,json,time,requests
def sms2():
                os.system("python sms-all.py")
try:
...
class nyepam:
	...
	def mulai(self):
		try:
			...
			print("[32m\nINGFO: \n       \x1b[0;36m[\x1b[0;37mTarget\x1b[0;36m] : undifined\n       \x1b[0;36m[\x1b[0;37mPesan\x1b[0;36m]  : Request Brutal Spam berhasil\n")
			takok()
...
os.system("xdg-open bit.ly/AmmarExecuted")

while True:
	try:
		os.system("python loken.py")
		sms2()
		print ("")
		print("SMS KE 2")
		print("[!] Example: 08xx")
		...
		asu=a[0:2]
		if a in(""," "):print("\033[36m[\033[33m!\033[36m] \033[32mMasukin Nomer Nya Njink:)")
